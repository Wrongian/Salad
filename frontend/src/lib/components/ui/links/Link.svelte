<script lang="ts">
  ...
  <div draggable={!isFocused} class="w-[90vw] overflow-hidden border-2 shadow-xl rounded-xl border-lime-300 {dragClass} mb-4 py-2">
    <div class="relative flex p-3">
        ...
        <div class="ps-1 w-[100px] m-auto">
          <button  on:click={async () => {await modalCallback(link.id); await invalidateAll()}} >
